...
```
 - hosts: all
   roles:
     - { role: tecris.maven, maven_major: 3, maven_version: 3.8.4, maven_home_parent_directory: /opt }
```
...
| maven_version | 3.8.4 | Version number|
| maven_home_parent_directory | /opt | MAVEN_HOME parent directory|
| maven_download_url |http://www.apache.org/dist/maven/maven-3/3.8.4/binaries/apache-maven-3.8.4-bin.tar.gz| If using mirror/proxy (see ansible [get_url](http://docs.ansible.com/ansible/latest/get_url_module.html)) |
